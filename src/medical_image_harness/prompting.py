...
def build_initial_analysis_prompt(
    *,
    ...
    return (
        ...
        "coordinates. Checklist items cite all supporting observation_ids as an "
        "array of exact IDs, never comma-joined evidence text. Every reference "
        "must resolve; assessable items cite only assessable supported/possible "
        "observations. Do not provide both nonempty observation_ids and legacy "
        "evidence fields. A single CT screenshot permits only "
